...
function GoogleSignupButton({ onSuccess, onError, isLoading }: GoogleSignupButtonProps) {
        ...
        <div className="create-account-page animate-fade-in-up">
            ...
            >
                ...
                <form onSubmit={handleSubmit} className="create-account-form">
                    <div className="create-account-form__section">
                        ...
                        <div className="create-account-form__roles">
                            ...
                            <RoleCard
                                ...
                                onClick={() => setSelectedRole(selectedRole === 'hr' ? null : 'hr')}
                            />
                        </div>
                    </div>

                    {/* College Admin Request Card - Only show when no role selected */}
                    {!selectedRole && (
                    ...
                    {/* Form fields - Only show after role is selected */}
                    {selectedRole && (
                        <>
                            {/* Google Sign-up - Only for students, shown at top */}
